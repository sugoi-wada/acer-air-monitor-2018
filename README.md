...
`custom_components/acer_air_monitor/translations/*` | [Translation files.](https://developers.home-assistant.io/docs/internationalization/custom_integration)
`custom_components/acer_air_monitor/__init__.py` | The component file for the integration.
`custom_components/acer_air_monitor/api.py` | This is a sample API client.
`custom_components/acer_air_monitor/binary_sensor.py` | Binary sensor platform for the integration.
`custom_components/acer_air_monitor/config_flow.py` | Config flow file, this adds the UI configuration possibilities.
`custom_components/acer_air_monitor/const.py` | A file to hold shared variables/constants for the entire integration.
`custom_components/acer_air_monitor/manifest.json` | A [manifest file](https://developers.home-assistant.io/docs/en/creating_integration_manifest.html) for Home Assistant.
`custom_components/acer_air_monitor/sensor.py` | Sensor platform for the integration.
`custom_components/acer_air_monitor/switch.py` | Switch sensor platform for the integration.
...
`tests/test_api.py` | Tests for `custom_components/acer_air_monitor/api.py`.
`tests/test_config_flow.py` | Tests for `custom_components/acer_air_monitor/config_flow.py`.
`tests/test_init.py` | Tests for `custom_components/acer_air_monitor/__init__.py`.
`tests/test_switch.py` | Tests for `custom_components/acer_air_monitor/switch.py`.
...
[commits]: https://github.com/sugoi-wada/acer-air-monitor-2018/commits/master
